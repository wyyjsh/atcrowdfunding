...
<script>
    $(function () {
        $("#toRightBtn").click(function () {
            ...
            // :eq(0)表示选择页面上的第1个
            // ">"表示选择子元素
            // :selected表示"被选中的"的option
            // appendTo()能够将jQery对象追加到指定位置
        ...
        $("#submitBtn").click(function () {
            ...
            // 提交时只提交表单内选中的数据,所以把"已分配"的部分全部选中
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <form role="form" action="assign/do/role/assign.html" class="form-inline">
                        ...
                        <button id="submitBtn" type="submit" style="width: 150px;margin: 20px 100px"
