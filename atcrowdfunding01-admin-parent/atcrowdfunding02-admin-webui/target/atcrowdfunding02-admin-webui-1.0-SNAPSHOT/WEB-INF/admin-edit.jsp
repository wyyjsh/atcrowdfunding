                ...
                <div class="panel-body">
                    <form action="admin/update.html" method="post" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <input value="${requestScope.admin.loginAcct}" type="text" name="loginAcct" class="form-control" id="exampleInputLoginAcct1"  placeholder="请输入登陆账号">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputUserName" >用户昵称</label>
                            <input value="${requestScope.admin.userName}" name="userName" type="text" class="form-control" id="exampleInputUserName" placeholder="请输入用户名称">
                        </div>
                        <div class="form-group">
